<?php
  ...
  $sqlc = "SELECT a.id_participante,a.nombre_apellido,a.ruta_img,b.descripcion FROM participante a inner join color b on(a.id_color = b.id_color) where a.id_color = $id $and ORDER BY a.id_participante DESC";
...
<body class="bg-[#0CB0A6]">
        ...
        <div class=" w-full">
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                <div class="flex items-center mb-5 gap-5">
                    ...
                    <label for="buscar">
                        <div class="btn text-white rounded-full w-20 flex justify-center p-3">
    ...
    <div class="flex justify-between items-center">
        <div class="ml-10 flex gap-5 my-5">
            ...
            <a class="btn p-3 px-5 text-white rounded-full" href="asistencia.php?color=1"><i
                    class="ti ti-clipboard-list"></i></a>
            <a class="btn p-3 px-5 text-white rounded-full" href="estadistica.php"><i
                    class="ti ti-chart-pie-filled"></i></a>
            <a class="btn p-3 px-5 text-white rounded-full" href="../juego/menu.php"><i
                    class="ti ti-brand-apple-arcade"></i></a>
    ...
    <div id="contenido"
        class="w-full text-white justify-center flex flex-wrap gap-5 text-sm mx-auto bg-[#AF3838] rounded-lg p-10">
        ...
        <div class="mb-5 ">
            ...
            <div class="">
                <a href="datos.php?id_participante=<?php echo $row['id_participante']; ?>">
                    <div id="content-img"
                        class="card flex items-center align-middle overflow-hidden justify-center w-80 h-[17rem] bg-gray-800 border-2 border-dashed rounded-lg">
                        <img id="imagenPrevisualizacion"
                            src="../../public/images/<?php echo $row['id_participante']; ?>-<?php echo $row['ruta_img']; ?>"
